...
const static wxString hmac_off				= wxT( "HMAC Off." );
const static wxString hmac_on				= wxT( "HMAC On." );
...
const static wxString pass_peek_tip			= wxT( "The first 4 characters of the generated password.");
...
const static wxString sm_tip					= wxT( "'Secure Mode' prevents shoulder surfing and tampering." );
const static wxString title					= wxT( "SHA1_Pass v1.5 BETA2" );
